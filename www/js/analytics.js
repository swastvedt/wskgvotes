...
var ANALYTICS = (function () {
    ...
    var setupGoogle = function() {
        _gaq.push(['_setAccount', APP_CONFIG.WSKG_GOOGLE_ANALYTICS.ACCOUNT_ID]);
        _gaq.push(['_setDomainName', APP_CONFIG.WSKG_GOOGLE_ANALYTICS.DOMAIN]);
        //_gaq.push(['_setCustomVar', 1, 'BC', '', 3]);
        _gaq.push(['_setCustomVar', 2, 'Topics', APP_CONFIG.WSKG_GOOGLE_ANALYTICS.TOPICS, 3]);
...
//        })();
        ...
        ga('create', APP_CONFIG.WSKG_GOOGLE_ANALYTICS.ACCOUNT_ID, 'auto');
       ga('send', 'pageview');
    }
